            ...
            <div class="form signup">
                <div class="form-content">
                    ...
                    <form action="${pageContext.request.contextPath}/${sign}" method="post">
                        ...
                        <div class="field input-field">
                            <input name="passw" type="password" placeholder="Create password" value="${passw}" class="password" name="password" id="pass">
                            <i class='bx bx-hide eye-icon' onclick="togglePassword('pass', 'eye-icon-pass')"></i>
							<span style="color: red; font-weight: 400px;">${error5}</span>
                        </div>
						
                        <div class="field input-field">
                            <input name="repassw" type="password" onkeyup="validateRePass()" placeholder="Confirm password" class="password" name="repassword" id="re">
                            <i class='bx bx-hide eye-icon' onclick="togglePassword('re', 'eye-icon-re')"></i>
							<span id="noti2" style="color: red; font-weight: 400px;">${error6}</span>
                        </div>
                    ...
                    <div class="form-link">
                        <span>Already have an account? <a href="${pageContext.request.contextPath}/${login}" class="link login-link">Login</a></span>
                    </div>
                </div>
