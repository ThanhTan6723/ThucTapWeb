    ...
    <div class="container">
        <div class="voucher-container">
            <c:if test="${empty listSaved}">
                <div><h4 style="color: #8f8f8f">Bạn chưa lưu voucher nào</h4></div>
            </c:if>
            <c:forEach var="voucher" items="${listSaved}">
                <div class="voucher" data-voucher-id="${voucher.id}">
                    ...
                    <div class="voucher-details">
                        ...
                        <div>Bắt đầu: <fmt:formatDate value="${voucher.startDate}" pattern="dd/MM/yyyy"/></div>
                        <div>Kết thúc: <fmt:formatDate value="${voucher.endDate}" pattern="dd/MM/yyyy"/></div>
                    </div>
